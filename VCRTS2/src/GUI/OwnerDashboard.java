...
public class OwnerDashboard extends AccountCreation implements ActionListener {
	...
	// inputted in GUI?
	// private Vehicleowner vr = new Vehicleowner(null, null, 0, null, 0, null, 0,
	...
	public OwnerDashboard(VehicleOwner Owner) {
		...
		String[][] jobList = {{ Owner.getName(), Owner.getEmail(), Owner.getId(), Integer.toString(Owner.getPhoneNum()),
				...
				{"", "","","","","","","",""}};
		vehicleInfoTable = new JTable(jobList, columnNames);
		 ...
		 * licenseLabel.setBounds(25, 50, 300, 20); licenseLabel.setFont(new
		 * Font("Comic Sans MS", Font.PLAIN, 20));
		 * licenseLabel.setForeground(Color.white);
		 * 
		 * carMakeLabel = new JLabel("Car Make: ", SwingConstants.RIGHT);
		 * carMakeLabel.setBounds(25, 90, 300, 20); carMakeLabel.setFont(new
		 * Font("Comic Sans MS", Font.PLAIN, 20));
		 * carMakeLabel.setForeground(Color.white);
		 * 
		 * carModelLabel = new JLabel("License Plate: ", SwingConstants.RIGHT);
		 * carModelLabel.setBounds(25, 130, 300, 20); carModelLabel.setFont(new
		 * Font("Comic Sans MS", Font.PLAIN, 20));
		 * carModelLabel.setForeground(Color.white);
		 * 
		 * carYearLabel = new JLabel("Car Year: ", SwingConstants.RIGHT);
		 * carYearLabel.setBounds(25, 170, 300, 20); carYearLabel.setFont(new
		 * Font("Comic Sans MS", Font.PLAIN, 20));
		 * carYearLabel.setForeground(Color.white);
		 * 
		 * residencyLabel = new JLabel("Residency Time (Hours): ",
		 * SwingConstants.RIGHT); residencyLabel.setBounds(25, 210, 300, 20);
		 * residencyLabel.setFont(new Font("Comic Sans MS", Font.PLAIN, 20));
		 * residencyLabel.setForeground(Color.white);
		 * 
		 * licenseField = new JTextField(); licenseField.setBounds(325, 50, 350, 35);
		 * licenseField.setFont(new Font("Comic Sans MS", Font.PLAIN, 20));
		 * 
		 * carMakeField = new JTextField(); carMakeField.setBounds(325, 90, 350, 35);
		 * carMakeField.setFont(new Font("Comic Sans MS", Font.PLAIN, 20));
		 * 
		 * carModelField = new JTextField(); carModelField.setBounds(325, 130, 350, 35);
		 * carModelField.setFont(new Font("Comic Sans MS", Font.PLAIN, 20));
		 * 
		 * carYearField = new JTextField(); carYearField.setBounds(325, 170, 350, 35);
		 * carYearField.setFont(new Font("Comic Sans MS", Font.PLAIN, 20));
		 * 
		 * residencyField = new JTextField(); residencyField.setBounds(325, 210, 350,
		 * 35); residencyField.setFont(new Font("Comic Sans MS", Font.PLAIN, 20));
		 */
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == buttonAddJob) {
			 ...
			 * 
			 * try { currentOwner.requestVehicle(licensePlate, carMake, carModel, carYear,
			 * residencyTime); } catch (Exception error ) {
			 * 
