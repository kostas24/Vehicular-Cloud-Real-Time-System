...
public class VehicleRenter extends Account implements Runnable {
	 ...
	 * vehicle renter object with all parameters for a job for future
	 * implementation.
	 */
	...
	/*
	 * Basic method in order to add a job using just jobDuration and jobID for
	 * current implementation.
	 */
	public void requestJob(int jobDuration, int jobID) throws IOException {
	...
	/*
	 * Method to delete a job using its JobID and returns a boolean to confirm the
	 * job was found and deleted to be used in GUI to throw error if the job is not
	 * found.
	 */
